...
class TranscriptProcessor:
    ...
    def __init__(
        self, config: TranscriptionConfig, cleanup_config: CleanupConfig, hf_token: str
    ):
    ...
    def _diarize_audio(self, audio, result: Dict, num_speakers: int) -> Dict:
        ...
        # Use newer pyannote model directly
        pipeline = Pipeline.from_pretrained(
            self.config.diarization_model, use_auth_token=self.hf_token
        )
        ...
        # Clean up GPU memory
        self._cleanup_gpu_memory(pipeline)
